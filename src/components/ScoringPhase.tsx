					...
					<div className="scoreboard">
						{sortedPlayers.map((player, index) => {
							...
							return (
								<div
									key={player.id}
									className={`score-entry ${isCurrentPlayer ? "current-player" : ""}`}
								>
									...
									{playerScore && (
										<div className="score-breakdown">
											<div className="score-item">
												...
												<span>{playerScore.atomicNumber}</span>
											</div>
											<div className="score-item">
											...
											<div className="score-item">
												...
												<span>{playerScore.atomicSymbol}</span>
											</div>
											{showRadioactivity && (
												<div className="score-item">
													<span>Radioactivity:</span>{" "}
													<span>{playerScore.radioactivity}</span>
												</div>
											)}
											<div className="score-item">
											...
											<div className="score-item">
												<span>Different Families:</span>{" "}
												<span>{playerScore.differentFamilies}</span>
											</div>
										</div>
									)}
								</div>
